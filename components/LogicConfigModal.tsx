            ...
            {isOpen && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 pointer-events-auto">
                    ...
                    <motion.div
                        ...
                        animate="animate"
                        exit="exit"
                        className="bg-slate-950 border border-red-900/50 rounded-2xl shadow-[0_0_50px_rgba(220,38,38,0.2)] w-full max-w-2xl overflow-hidden relative z-10 flex flex-col max-h-[90vh]"
                    >
